...
ffmpeg -y -i %input% %qqq03%  -c:a libopus  -c:v libvpx-vp9  -deadline realtime  -cpu-used 5   -crf 45 -b:v 200K -maxrate 200K -bufsize 200K  -b:v 0   -vf "scale=400:400:force_original_aspect_ratio=decrease"  %output%
