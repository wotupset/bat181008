...
set tt=-ss 0:1:47.0 -to 0:1:57.0
set tt=-ss 0:0:41.75 -to 0:0:44.35
set tt=-ss 0:1:14.2 -to 0:1:19.7
set tt=-ss 0:1:43.76 -to 0:1:56.6
set tt=-ss 0:0:32.2 -to 0:0:40.2
set tt=
echo %tt%
...
ffmpeg  %tt% -i %input% -c:v libvpx-vp9 -pix_fmt yuv420p %vf% %ppp01%  -y %output%
