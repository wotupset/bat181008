...
..\ffmpeg -loop 1 -i "01.jpg" -t 10 -s 400x300 -c:v h264_nvenc -pix_fmt yuv420p -preset fast -an -y "01x.mp4"
..\ffmpeg -stream_loop 5 -i "01x.mp4" -c copy -y "01x_loop.mp4"
..\ffmpeg -stream_loop 9 -i "01x_loop.mp4" -c copy -y "01x_loop5.mp4"
del "01x.mp4"
del "01x_loop.mp4"

set tt=-ss 0:0:0.0 -to 0:2:20.0
echo %tt%

..\ffmpeg %tt% -i "01.mp3" -c:v copy -y "01x.mp3"
