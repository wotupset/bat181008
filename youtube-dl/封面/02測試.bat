...
..\ffmpeg -loop 1 -i 3333.jpg  -i 01.flac -shortest  -c:v h264_nvenc -pix_fmt yuv420p  -r 5 -y output%nnn%.mp4
...
..\ffmpeg -f lavfi -i testsrc=size=400x300 -i 01.flac -shortest  -y output.mp4
