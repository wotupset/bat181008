...
set tt=-ss 0:20:12.88 -to 0:20:14.28
set tt=-ss 0:23:12.8 -to 0:23:22.8
set tt=-ss 0:17:21.0 -to 0:19:21.0
set tt=
echo %tt%


set time0=%date%_%time%
ffmpeg %tt% -hwaccel auto -i %input% -c:v h264_nvenc -cq 20  %vf%  %qqq01%  -y  %output%
