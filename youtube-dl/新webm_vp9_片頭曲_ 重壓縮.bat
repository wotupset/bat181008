...
set crf2=-b:v 150K -minrate 100k -maxrate 150k 
set crf2=-b:v 400K -minrate 10k -maxrate 500k 
set crf2=-b:v 150K -minrate 100k -maxrate 150k
set crf2=-b:v 300K -minrate 300k -maxrate 300k
set crf2=-b:v 200K -minrate 200k -maxrate 200k  
set crf20=
...
set qqq040=-vf "scale=640:480:force_original_aspect_ratio=decrease,setsar=1:1" 
