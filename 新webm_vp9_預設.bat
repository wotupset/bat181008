...
ffmpeg -y  -ss 00:00:00.0 -to 00:00:10.0  -i %qqq01%  -c:v libvpx-vp9 -crf 20 -b:v 0k -deadline realtime -vf "scale=800:800:force_original_aspect_ratio=decrease"   "%qqq02%" 
