...
set qqq02=_output_2pass.webm


ffmpeg -i "%qqq01%" -c:v libvpx-vp9 -crf 30 -b:v 0 -pass 1 -c:a libopus -y -f webm NUL && ^
ffmpeg -i "%qqq01%" -c:v libvpx-vp9 -crf 30 -b:v 0 -pass 2 -c:a libopus -y "%qqq02%" 
