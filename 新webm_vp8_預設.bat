set /p input=檔案:
set output=_output_vp8_預設.webm
...
-c:a libopus
 ...
 -crf 50 -b:v 100k -r 2 
-ss 00:00:00.0 -to 00:04:0.0 
 -crf 20 -b:v 0 

-ss 00:00:00.0 -t 00:0:13.0
 -b:v 1000k  -sharpness 1 -tune psnr -quality best -deadline best

-crf 20 -b:v 0 -sharpness 1 -tune psnr -quality best -deadline best 
-crf 20 -b:v 0 -deadline best 
...
GOTO aaa
 ...
 -b:v 500k -minrate 300k -maxrate 1000k -fs 5M

-fs 5M
-crf 25 -b:v 0
-b:v 500k -minrate 500k -maxrate 2000k 
-b:v 1000k -minrate 500k -maxrate 1000k 


-vf "scale=400:-2:force_original_aspect_ratio=decrease:flags=lanczos"
-ss 00:00:00.0 -t 00:0:30.0 
-ss 00:7:57.5 -t 00:2:0.0  
