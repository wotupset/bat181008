...
ffmpeg  -i 01.mkv -vf "drawtext= fontfile=111.ttf:  text='%ddd%': x=10:y=10: fontsize=50: fontcolor=white: box=1:boxcolor=black@0.5:  timecode='00\:00\:00\:000': rate=25: " -y output.mkv
